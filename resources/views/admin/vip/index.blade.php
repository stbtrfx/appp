    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{__('site.vip')}}
                    <!--begin::Separator-->
    ...
    <div class="card rounded mb-5 mb-xl-8 shadow-lg">
        ...
        <div class="card-header rounded border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{__('site.vip')}}</span>
            </h3>

            <div class="card-toolbar">
            <a href="{{route('vip.create')}}" class="btn btn-sm btn-light-primary">
            ...
            <!--end::Svg Icon-->{{__('Add')}}{{__('site.vip')}}+</a>
        </div>
                ...
                <table class="table table-hover align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="text-center border-3 fw-bolder text-muted bg-light">
                            ...
                            <th class="ps-2 min-w-125px rounded-start">@lang('site.months_no')  </th>
                        ...
                        @foreach ($vips as $c)
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('vip.edit', $c->id) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->title_en}}</a>
                        ...
                        <td class="px-3">
                            <div class="d-flex flex-column">
                                ...
                                <td class="px-3">
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $c->months_no }}</a>
                                    </div>
                                </td>
                                <td class="px-3">
                                    <div class="d-flex flex-column">
                                 ...
                                 <a href="{{ route('vip.edit', $c->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <!--end::Svg Icon-->
                                   ...
                                   <form action="{{ route('vip.destroy', $c->id) }}" method="post" id='delform'
