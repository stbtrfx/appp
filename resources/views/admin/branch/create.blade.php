    ...
    <div class="container-fluid page__container p-2">
        ...
        <div class="card rounded card-form__body card-body shadow-lg">
            <form method="post" action="{{ route('branch.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.address') @lang('site.in
                        English') </label>
                ...
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.area') @lang('site.in
                        English') </label>
                    <input type='text' name="area_en" class="form-control" value="{{ old('area_en') }}" />
                </div>
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.area') @lang('site.in
                        Arabic') </label>
                    <input type='text' name="area_ar" class="form-control" value="{{ old('area_ar') }}" />
                </div>
                ...
                <div class="form-group mb-10">
                    <label for="package_per_day" class="required form-label">@lang('site.Number of Allowed Packages Per
                        Day')</label>
                    <input type='number' name="package_per_day" class="form-control"
                        value="{{ old('package_per_day') }}" />
                </div>
